    ...
    <div className='flex mx-[5%] gap-[5%] pt-[10%]'>
        <div className='w-[50%] h-screen'>
            <h2 className='text-5xl font-semibold tracking-tight leading-[60px]'>
                A maior 
                <span className='mx-4 px-5 pb-1 bg-red2 text-white'>variedade</span> <br/>
            ...
            <button className='px-8 py-2 text-white bg-red  rounded-sm mt-10'>Leia a pesquisa completa</button>
        </div>

        <div className='w-[50%] mx-auto flex flex-col mt-10 h-screen'>
            <p className='text-center text-red text-3xl font-bold mb-14'>RevoluTech interprice</p>

            <img src={GloboImg} className='w-4/5 mx-auto' alt="" />
        </div>
    </div>
  )
}
